    ...
    <AppLayout showBottomNav={false}>
      ...
      {showPaymentForm && (
        <>
          ...
          <Card className="mb-6">
            <div className="p-6">
              <div className="flex items-center p-4 border-2 border-esimphony-red bg-red-50 rounded-esim mb-4">
              ...
              <div className="border-t pt-4">
                <p className="text-sm font-medium text-esimphony-gray mb-3">Accepted Cards:</p>
                <div className="flex space-x-4">
                  ...
                  <i className="fab fa-cc-discover text-3xl text-orange-500"></i>
                </div>
              </div>
            </div>
          </Card>
